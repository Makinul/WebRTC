package com.makinul.webrtc.webrtc
...
class WebRTCClient @Inject constructor(
    ...
    private fun initPeerConnectionFactory() {
        val options = PeerConnectionFactory.InitializationOptions.builder(context)
            .setEnableInternalTracer(true).setFieldTrials("WebRTC")
    ...
    //negotiation section
    fun receiveCall(target: String) {
        showLog("receive call create offer $target")
    ...
    fun initiateCall(target: String) {
        showLog("initiate call create answer $target")
    ...
    companion object {
        private const val TAG = "FirebaseWebRTC WebRTCClient"
    }
}